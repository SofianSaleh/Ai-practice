...
class Support_Vector_Machine:
    ...
    def visualize(self):
        ...
        dec1 = hyperplane(hyper_x_min, self.w, self.b, 0)
        dec2 = hyperplane(hyper_x_max, self.w, self.b, 0)
        self.ax.plot([hyper_x_min, hyper_x_max], [dec1, dec2])
        plt.show()


data_dict = {
    -1: np.array([[11, 7], [12, 8], [13, 8]]),
